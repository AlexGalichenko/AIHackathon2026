...
test.describe('<Feature or Component Name>', () => {
  test('<test title from test case>', async ({ page }) => {
    ...
    // --- Steps ---
    // Step 1: <description from test case step>
    await page.getByRole('textbox', { name: 'Email' }).fill('user@example.com');

    // Step 2: <description from test case step>
...
- If the test case has multiple expected results at intermediate steps, add inline assertions after those steps
